...
public class ClassNameListener implements ActionListener {
	...
	Main main;
	public ClassNameListener(Main main, JTextField textClass1, JTextField textClass2,JTextField textClass3,JTextField textClass4,JTextField textClass5,JTextField textClass6,JTextField textClass7) {
		this.main = main;
